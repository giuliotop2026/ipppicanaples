    ...
    if not uploaded_files:
        ...
        with st.spinner("ZORRO STA CALCOLANDO L'INDICE DI DENSITÀ TECNICA REALE... ⏳"):
            try:
                ...
                FASE 0: PROTOCOLLO ANTI-ALLUCINAZIONE E LETTURA COLONNE (CRITICO)
                LE COLONNE DEL MANIFESTO POSSONO ESSERE DISALLINEATE. APPLICA QUESTE LEGGI DELLA FISICA IPPICA:
                1. IL RATING (RT) NON PUÒ MAI SUPERARE IL VALORE DI 150. SE LEGGI UN NUMERO COME "303" O "164" SOTTO LA COLONNA RT, FERMATI: STAI LEGGENDO LA COLONNA SBAGLIATA. QUELLO È IL 'GG' (GIORNI DI RIPOSO). IL RATING IN QUEL CASO È MANCANTE.
                2. GLI 'ULTIMI ARRIVI' (FORMA) SONO SOLO NUMERI SINGOLI (ES. 1, 2, 3, 4). NON CONFONDERLI CON IL GG.
                3. SE UN CAVALLO HA GG > 200 E NON FA UN CLASS DROP ENORME, È UN CADAVERE. NESSUN PUNTO BONUS GLI PUÒ SALVARE LA VITA E IL SUO INDICE CROLLA.
                
                FASE 1: PROTOCOLLO DATI FANTASMA E SCANSIONE DELLA SABBIA
                SE MANCANO I RATING (RT) O I GIORNI DI RIPOSO (GG) DOPO AVER SUPERATO LA FASE 0, NON SCARTARE SUBITO. 
                ...
                VALUTA *TUTTI* I CAVALLI DELLA GARA (BASANDOTI SEMPRE SULLE PARTICELLE [cite: 2026-01-25]), INCLUSO IL FAVORITO, E LEGGI ATTENTAMENTE I COMMENTI E I PREMI IN DENARO (PURSE) ALLEGATI. CALCOLA MENTALMENTE QUESTO PUNTEGGIO:
                - BASE (SE RT È PRESENTE E CORRETTO <150, PER GLI SFIDANTI): (RT CAVALLO - RT FAVORITO) * 2.5.
                - BASE (SE RT È PRESENTE E CORRETTO <150, PER IL FAVORITO): (RT FAVORITO - RT SECONDO MIGLIORE) * 2.5.
                - BASE (SE RT MANCA O È STATO CORRETTO IN GG): USA IL 'BONUS CLASSE FANTASMA' CALCOLATO NELLA FASE 1.
                - RUGGINE (SE GG È PRESENTE E > 30 E NON C'È UN CLASS DROP IN USA NÉ È SCALZO IN FRANCIA): SOTTRAI (GG - 30) * 0.5. (SE GG < 30 E > 0): AGGIUNGI (30 - GG) * 0.2.
                ...
                SE NESSUNA PARTICELLA RAGGIUNGE UN INDICE TOTALE DI ALMENO 55.0 PUNTI (CON DATI PURI O CLASSE FANTASMA/BONUS TERRITORIO), LA GARA È DI SABBIA E DEVE ESSERE SCARTATA.
                LA SENTENZA DEVE ESSERE ESATTAMENTE:
                "🚨 NESSUN CAVALLO RAGGIUNGE LA SOGLIA DEL GRANITO. ORDINE SUPREMO: NON GIOCARE."
                
                FASE 4: REFERTO FINALE DELLA VITTORIA
                SE ESISTE UN CAVALLO CHE SUPERA I 55.0 PUNTI ED È IL MIGLIORE IN ASSOLUTO, EGLI È IL NOSTRO BERSAGLIO.
                ...
                '📊 INDICE DI DENSITÀ CALCOLATO: [INSERISCI IL PUNTEGGIO STIMATO E SPIEGA DETTAGLIATAMENTE COME HAI ASSEGNATO I PUNTI. CONFERMA ESPLICITAMENTE DI AVER APPLICATO IL PROTOCOLLO ANTI-ALLUCINAZIONE PER DISTINGUERE L'RT DAL GG]'
                """
