        ...
        with st.spinner("ZORRO STA CALCOLANDO L'INDICE DI DENSITÀ TECNICA REALE... ⏳"):
            try:
                ...
                if nazione == "USA":
                    ...
                    - SE 'RT.' MANCA, CERCA LA COMPENSAZIONE NELLA 'CLASSE'.
                    - ANALIZZA IL SALTO: SE SCENDE DA 'STAKES' A 'CLAIMING', È UN TITANO E PRENDE IL BONUS FANTASMA.
                    """
                ...
                - IN USA/AUSTRALIA/SUD AFRICA/FRANCIA: GUARDA IL SALTO DI CATEGORIA, IL PESO, IL NOME DEL FANTINO, I COMMENTI DEGLI ESPERTI O I PIAZZAMENTI IN CARRIERA.
                ...
                VALUTA *TUTTI* I CAVALLI DELLA GARA, INCLUSO IL FAVORITO, E LEGGI ATTENTAMENTE I COMMENTI ALLEGATI. CALCOLA MENTALMENTE QUESTO PUNTEGGIO:
                ...
                - RUGGINE (SE GG È PRESENTE E > 30): SOTTRAI (GG - 30) * 0.5 (ECCETTO SE APPLICHI L'ANNULLAMENTO RUGGINE DELLA FRANCIA). (SE < 30): AGGIUNGI (30 - GG) * 0.2.
                ...
                - BONUS TERRITORIO: AGGIUNGI I PUNTI BONUS SPECIFICI (ES. SCALZO, PISTA E DISTANZA) DEFINITI NELLE REGOLE DEL TERRITORIO SELEZIONATO.

                FASE 3: LA SOGLIA DEL CEMENTO
                SE NESSUN CAVALLO (NÉ FAVORITO NÉ SFIDANTE) RAGGIUNGE UN INDICE TOTALE DI ALMENO 55.0 PUNTI (CON DATI PURI O CLASSE FANTASMA/BONUS FRANCIA), LA GARA È DI SABBIA E DEVE ESSERE SCARTATA.
                LA SENTENZA DEVE ESSERE ESATTAMENTE:
                ...
                '📊 INDICE DI DENSITÀ CALCOLATO: [INSERISCI IL PUNTEGGIO STIMATO E SPIEGA DETTAGLIATAMENTE COME HAI ASSEGNATO I PUNTI, SOPRATTUTTO I BONUS COME SCALZO, PISTA E DISTANZA O CLASSE FANTASMA]'
                """
